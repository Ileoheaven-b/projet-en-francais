            ...
            <div className={styles.rowContainer}>
              ...
              >
                <div>
                  ...
                  <div className={styles.articleText}>
                    Les cafés oü les jeunes de Botosani choisissent de passer
                    leur temps libre...
                  </div>
                  <Image
                    className={styles.articleImage}
            ...
            <div className={styles.rowContainer}>
              ...
              >
                ...
                <div className={styles.articleText}>
                  ...
                  d'apprendre et d'améliorer vos notes ? ChatGPT est votre
                  nouveau partenaire d'étude.
                </div>
                <Image
                  className={styles.articleImage}
                  src={thumbnail1}
              ...
              >
                <div>
                  ...
                  <div className={styles.articleText}>
                    ...
                    saviez pas où ?Cet article vous donnera un aperçu des
                    options dont vous disposez localement ! Nos journalistes ont
                    analysé toutes les options pour faire du sport à Botosani...
                  </div>
                  <Image
                    className={styles.articleImage}
                    src={thumbnail4}
